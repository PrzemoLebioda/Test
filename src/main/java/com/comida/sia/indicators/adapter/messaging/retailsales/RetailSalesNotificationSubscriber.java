...
@Component("RetailSalesNotificationSubscriber")
public class RetailSalesNotificationSubscriber extends NotificationSubscriber {

	@Override
	@RabbitListener(queues = RabbitmqConfig.RETAIL_SALES_QUEUE)
