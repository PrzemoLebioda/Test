...
public class SynchronizeTreasuryYealdWeekly03MonthCommand  extends Command<TreasuryYealdService>{

	private SynchronizationStateDto syncState;
	
	public SynchronizeTreasuryYealdWeekly03MonthCommand(TreasuryYealdService requestClass, SynchronizationStateDto syncState) {
		super(requestClass);
	...
	public void execute() {
		AssertionConcern.assertNotNull(syncState, "Current synchronization state is mandatory in order to execute command");
		requestClass.synchronizeTreasuryYealdWeekly03Month(syncState);
	}
