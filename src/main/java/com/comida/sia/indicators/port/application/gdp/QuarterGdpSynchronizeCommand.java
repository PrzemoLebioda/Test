...
public class QuarterGdpSynchronizeCommand extends Command<GdpService>{

	private SynchronizationStateDto syncState;
	
	public QuarterGdpSynchronizeCommand(GdpService requestClass, SynchronizationStateDto syncState) {
		super(requestClass);
