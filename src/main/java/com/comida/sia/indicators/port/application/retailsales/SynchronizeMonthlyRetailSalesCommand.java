...
public class SynchronizeMonthlyRetailSalesCommand extends Command<RetailSalesService> {

	private SynchronizationStateDto syncState;
	
	public SynchronizeMonthlyRetailSalesCommand(RetailSalesService requestClass, SynchronizationStateDto syncState) {
		super(requestClass);
