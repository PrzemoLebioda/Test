...
public class AnnualGdpSynchronizeCommand extends Command<GdpService>{

	private SynchronizationStateDto syncState;
	
	public AnnualGdpSynchronizeCommand(GdpService requestClass, SynchronizationStateDto syncState) {
		super(requestClass);
