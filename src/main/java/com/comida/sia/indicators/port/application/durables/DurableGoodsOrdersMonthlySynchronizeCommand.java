...
public class DurableGoodsOrdersMonthlySynchronizeCommand extends Command<DurableGoodsOrdersService>{

	private SynchronizationStateDto syncState;
	
	public DurableGoodsOrdersMonthlySynchronizeCommand(DurableGoodsOrdersService requestClass, SynchronizationStateDto syncState) {
		super(requestClass);
