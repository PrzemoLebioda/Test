...
public class GdpAnnualSynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public GdpAnnualSynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.GDP_ANNUAL_SYNCED;
	}
