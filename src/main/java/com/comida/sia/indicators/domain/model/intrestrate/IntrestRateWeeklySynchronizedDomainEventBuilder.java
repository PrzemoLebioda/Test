...
public class IntrestRateWeeklySynchronizedDomainEventBuilder implements DomainEventBuilder<IndicatorsDataEntry, IntrestRate> {

	public IntrestRateWeeklySynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<IndicatorsDataEntry, IntrestRate> report) {
		...
		return new IntrestRateWeeklySynchronizedDomainEvent(report.getSummary());
	}
