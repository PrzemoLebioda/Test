...
public class TreasuryYealdWeekly07YearSynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public TreasuryYealdWeekly07YearSynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.TREASURY_YEALD_WEEKLY_07_YEAR_SYNCED;
	}
