...
public class TreasuryYealdMonthly05YearSynchronizedDomainEventBuilder implements DomainEventBuilder<TreasuryYealdEntry, TreasuryYeald> {

	public TreasuryYealdMonthly05YearSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<TreasuryYealdEntry, TreasuryYeald> report) {
		...
		return new TreasuryYealdMonthly05YearSynchronizedDomainEvent(report.getSummary());
	}
