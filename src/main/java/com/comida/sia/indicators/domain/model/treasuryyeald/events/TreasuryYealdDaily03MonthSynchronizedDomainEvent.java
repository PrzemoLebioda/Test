...
public class TreasuryYealdDaily03MonthSynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public TreasuryYealdDaily03MonthSynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.TREASURY_YEALD_DAILY_03_MONTH_SYNCED;
	}
