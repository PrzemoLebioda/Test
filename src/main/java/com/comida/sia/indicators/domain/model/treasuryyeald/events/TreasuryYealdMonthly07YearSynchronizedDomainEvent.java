...
public class TreasuryYealdMonthly07YearSynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public TreasuryYealdMonthly07YearSynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.TREASURY_YEALD_MONTHLY_07_YEAR_SYNCED;
	}
