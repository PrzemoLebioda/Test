...
public class IntrestRateMonthlySynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public IntrestRateMonthlySynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.INTREST_RATE_MONTHLY_SYNCED;
	}
