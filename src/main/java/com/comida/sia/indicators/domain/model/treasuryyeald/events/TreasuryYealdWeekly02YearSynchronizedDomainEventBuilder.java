...
public class TreasuryYealdWeekly02YearSynchronizedDomainEventBuilder implements DomainEventBuilder<TreasuryYealdEntry, TreasuryYeald> {

	public TreasuryYealdWeekly02YearSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<TreasuryYealdEntry, TreasuryYeald> report) {
		...
		return new TreasuryYealdWeekly02YearSynchronizedDomainEvent(report.getSummary());
	}
