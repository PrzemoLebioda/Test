...
public class GdpPerCapitaAnnualSynchronizedDomainEventBuilder implements DomainEventBuilder<IndicatorsDataEntry, GrossDomesticProductPerCapita> {

	public GdpPerCapitaAnnualSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<IndicatorsDataEntry, GrossDomesticProductPerCapita> report) {
		...
		return new GdpPerCapitaAnnualSynchronizedDomainEvent(report.getSummary());
	}
