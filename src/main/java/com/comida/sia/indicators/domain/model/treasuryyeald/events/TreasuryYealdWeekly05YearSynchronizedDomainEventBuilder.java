...
public class TreasuryYealdWeekly05YearSynchronizedDomainEventBuilder implements DomainEventBuilder<TreasuryYealdEntry, TreasuryYeald> {

	public TreasuryYealdWeekly05YearSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<TreasuryYealdEntry, TreasuryYeald> report) {
		...
		return new TreasuryYealdWeekly05YearSynchronizedDomainEvent(report.getSummary());
	}
