...
public class GrossDomesticProductTranslator implements ModelTranslator<IndicatorsDataEntry, GrossDomesticProduct> {

	@Override
	public GrossDomesticProduct translate(IndicatorsDataEntry source) throws ParseException {
		return new GrossDomesticProduct.GDPBuilder(UUID.randomUUID())
