...
public class GdpQuarterSynchronizedDomainEventBuilder implements DomainEventBuilder<IndicatorsDataEntry, GrossDomesticProduct> {

	public GdpQuarterSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<IndicatorsDataEntry, GrossDomesticProduct> report) {
		...
		return new GdpQuarterSynchronizedDomainEvent(report.getSummary());
	}
