...
public class TreasuryYealdDaily10YearSynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public TreasuryYealdDaily10YearSynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.TREASURY_YEALD_DAILY_10_YEAR_SYNCED;
	}
