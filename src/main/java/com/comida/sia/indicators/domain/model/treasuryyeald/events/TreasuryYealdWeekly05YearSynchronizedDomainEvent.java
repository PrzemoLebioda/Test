...
public class TreasuryYealdWeekly05YearSynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;
	
	public TreasuryYealdWeekly05YearSynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.TREASURY_YEALD_WEEKLY_05_YEAR_SYNCED;
	}
