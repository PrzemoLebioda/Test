...
public class TreasuryYealdWeekly10YearSynchronizedDomainEventBuilder implements DomainEventBuilder<TreasuryYealdEntry, TreasuryYeald> {

	public TreasuryYealdWeekly10YearSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<TreasuryYealdEntry, TreasuryYeald> report) {
		...
		return new TreasuryYealdWeekly10YearSynchronizedDomainEvent(report.getSummary());
	}
