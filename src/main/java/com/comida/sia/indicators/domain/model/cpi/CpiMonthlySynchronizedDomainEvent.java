...
public class CpiMonthlySynchronizedDomainEvent implements SubjectedPayload{

	@Getter SynchronizationSummary summary;

	public CpiMonthlySynchronizedDomainEvent(SynchronizationSummary summary) {
	...
	public Subject getSubject() {
		return Subject.CPI_MONTHLY_SYNCED;
	}
