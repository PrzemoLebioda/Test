...
public class TreasuryYealdMonthly30YearSynchronizedDomainEventBuilder implements DomainEventBuilder<TreasuryYealdEntry, TreasuryYeald> {

	public TreasuryYealdMonthly30YearSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<TreasuryYealdEntry, TreasuryYeald> report) {
		...
		return new TreasuryYealdMonthly30YearSynchronizedDomainEvent(report.getSummary());
	}
