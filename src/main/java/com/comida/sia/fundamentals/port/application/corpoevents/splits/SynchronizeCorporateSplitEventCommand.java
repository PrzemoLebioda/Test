...
public class SynchronizeCorporateSplitEventCommand extends Command<CorporateSplitEventService>{

	private String tickerSymbol;
	private SynchronizationStateDto syncState;
	
	public SynchronizeCorporateSplitEventCommand(
			CorporateSplitEventService requestClass,
			String tickerSymbol,
