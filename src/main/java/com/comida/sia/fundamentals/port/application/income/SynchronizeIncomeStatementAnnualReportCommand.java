...
public class SynchronizeIncomeStatementAnnualReportCommand extends Command<IncomeStatementsRegisterService> {

	private String tickerSymbol;
	private SynchronizationStateDto syncState;
	
	public SynchronizeIncomeStatementAnnualReportCommand(
			IncomeStatementsRegisterService requestClass,
			String tickerSymbol,
	...
	public void execute() {
		...
		requestClass.synchronizeAnnualReports(tickerSymbol, syncState);	
	}
