...
public class SynchronizeIncomeStatementQuarterReportCommand extends Command<IncomeStatementsRegisterService> {

	private String tickerSymbol;
	private SynchronizationStateDto syncState;
	
	public SynchronizeIncomeStatementQuarterReportCommand(
