...
public class SynchronizeSharesOutstandingReportCommand extends Command<SharesOutstandingService>{

	private String tickerSymbol;
	private SynchronizationStateDto syncState;
	
	public SynchronizeSharesOutstandingReportCommand(
			SharesOutstandingService requestClass,
			String tickerSymbol,
