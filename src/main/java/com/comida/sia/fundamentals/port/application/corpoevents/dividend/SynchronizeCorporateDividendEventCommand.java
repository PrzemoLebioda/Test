...
public class SynchronizeCorporateDividendEventCommand extends Command<CorporateDividendEventService> {
	
	private String tickerSymbol;
	private SynchronizationStateDto syncState;

	public SynchronizeCorporateDividendEventCommand(
			CorporateDividendEventService requestClass,
			String tickerSymbol,
	...
	public void execute() {
		...
		requestClass.synchronizeEvents(tickerSymbol, syncState);	
	}
