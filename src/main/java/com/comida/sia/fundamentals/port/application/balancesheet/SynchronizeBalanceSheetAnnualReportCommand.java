...
public class SynchronizeBalanceSheetAnnualReportCommand extends Command<BalanceSheetsRegisterService>{

	private String tickerSymbol;
	private SynchronizationStateDto syncState;
	
	public SynchronizeBalanceSheetAnnualReportCommand(
			BalanceSheetsRegisterService requestClass, 
			String tickerSymbol,
