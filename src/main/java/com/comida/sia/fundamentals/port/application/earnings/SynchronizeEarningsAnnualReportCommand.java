...
public class SynchronizeEarningsAnnualReportCommand extends Command<EarningsRegisterService>{
	private String tickerSymbol;
	private SynchronizationStateDto syncState;

	public SynchronizeEarningsAnnualReportCommand(
			EarningsRegisterService requestClass,
			String tickerSymbol,
