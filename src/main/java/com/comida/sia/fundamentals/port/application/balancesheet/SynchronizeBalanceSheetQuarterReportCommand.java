...
public class SynchronizeBalanceSheetQuarterReportCommand extends Command<BalanceSheetsRegisterService> {

	private String tickerSymbol;
	private SynchronizationStateDto syncState;
	
	
	public SynchronizeBalanceSheetQuarterReportCommand(
