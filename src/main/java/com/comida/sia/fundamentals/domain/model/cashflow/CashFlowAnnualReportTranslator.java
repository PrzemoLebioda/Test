...
public class CashFlowAnnualReportTranslator implements ModelTranslator<CashFlowReportData, CashFlowReport>{

	@Override
	public CashFlowReport translate(CashFlowReportData source) throws ParseException {
		return new CashFlowReport.Builder(UUID.randomUUID(), source.getTickerSymbol(), ReportType.ANNUAL_REPORT)
