...
public class BalanceSheetAnnualReportTranslator implements ModelTranslator<BalanceSheetReportData, BalanceSheetReport> {

	@Override
	public BalanceSheetReport translate(BalanceSheetReportData source) throws ParseException {
		return new BalanceSheetReport.Builder(UUID.randomUUID(), source.getTickerSymbol(), ReportType.ANNUAL_REPORT)
