...
public class ListedStockSynchronizedDomainEventBuilder implements DomainEventBuilder<StockData, Stock>{

	public ListedStockSynchronizedDomainEventBuilder() {
		super();
	}
	...
	public SubjectedPayload build(SynchronizationReport<StockData, Stock> report) {
		...
		return new ListedStockSynchronizedDomainEvent(report.getSummary());
	}
