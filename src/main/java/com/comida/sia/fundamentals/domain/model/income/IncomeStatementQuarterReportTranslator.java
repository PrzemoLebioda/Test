...
public class IncomeStatementQuarterReportTranslator implements ModelTranslator<IncomeStatementReportData, IncomeStatementReport> {

@Override
public IncomeStatementReport translate(IncomeStatementReportData source) throws ParseException {
	return new IncomeStatementReport.Builder(UUID.randomUUID(), source.getTickerSymbol(), ReportType.QUARTER_REPORT)
