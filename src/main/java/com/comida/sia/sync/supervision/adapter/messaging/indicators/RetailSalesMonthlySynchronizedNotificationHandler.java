...
import com.comida.sia.indicators.port.messaging.retailsales.RetailSalesMonthlySynchronizedNotification;
...
@Component("RetailSalesMonthlySynchronizedNotificationHandler")
public class RetailSalesMonthlySynchronizedNotificationHandler implements NotificationHandler {
	
	private RetailSalesMonthlySynchronizedNotification notification;
	...
	public RetailSalesMonthlySynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, RetailSalesMonthlySynchronizedNotification.class);
			
			if(Subject.RETAIL_SALES_MONTHLY_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(RetailSalesMonthlySynchronizedDomainEvent domainEvent) {
