...
import com.comida.sia.exchangequote.port.messaging.ExchangeQuoteInterday01MinSynchronizedNotification;
...
@Component("ExchangeQuoteInterday01MinSynchronizedNotificationHandler")
public class ExchangeQuoteInterday01MinSynchronizedNotificationHandler implements NotificationHandler{

	private ExchangeQuoteInterday01MinSynchronizedNotification notification;
	...
	public ExchangeQuoteInterday01MinSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, ExchangeQuoteInterday01MinSynchronizedNotification.class);
			
			if(notification.getSubject().equals(Subject.EXCHANGE_QUOTE_INTERDAY_01_SYNCED)) {
				return true;
			} else {
				return false;
			}
	...
	private Command<ExchangeQuotesSynchronizationSupervisorService> buildCommand(ExchangeQuoteInterday01MinSynchronizedDomainEvent domainEvent) {
