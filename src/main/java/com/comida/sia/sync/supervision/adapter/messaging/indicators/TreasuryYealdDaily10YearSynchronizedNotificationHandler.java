...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdDaily10YearSynchronizedNotification;
...
@Component("TreasuryYealdDaily10YearSynchronizedNotificationHandler")
public class TreasuryYealdDaily10YearSynchronizedNotificationHandler implements NotificationHandler {
	
	private TreasuryYealdDaily10YearSynchronizedNotification notification;
	...
	public TreasuryYealdDaily10YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdDaily10YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_DAILY_10_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(TreasuryYealdDaily10YearSynchronizedDomainEvent domainEvent) {
