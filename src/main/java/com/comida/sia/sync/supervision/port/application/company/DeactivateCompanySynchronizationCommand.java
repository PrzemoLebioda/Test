...
public class DeactivateCompanySynchronizationCommand extends Command<CompanySynchronizationSupervisorService> {
	private String tickerSymbol;
	private Date ipoDate;
	private AssetType assetType;
	
	public DeactivateCompanySynchronizationCommand(CompanySynchronizationSupervisorService requestClass, String tickerSymbol, Date ipoDate, AssetType assetType) {
		super(requestClass);
	...
	private void setTickerSymbol(String tickerSymbol) {
		AssertionConcern.assertNotEmpty(tickerSymbol, "Ticker symbol is mandatory in order to create deactivate company synchronization command");
	...
	public void execute() throws ParseException {
		requestClass.deactivateSynchronization(tickerSymbol, ipoDate, assetType);
	}
}
