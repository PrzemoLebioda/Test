...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdMonthly02YearSynchronizedNotification;
...
@Component("TreasuryYealdMonthly02YearSynchronizedNotificationHandler")
public class TreasuryYealdMonthly02YearSynchronizedNotificationHandler implements NotificationHandler{

	private TreasuryYealdMonthly02YearSynchronizedNotification notification;
	...
	public TreasuryYealdMonthly02YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdMonthly02YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_MONTHLY_02_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(TreasuryYealdMonthly02YearSynchronizedDomainEvent domainEvent) {
