...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdDaily02YearSynchronizedNotification;
...
@Component("TreasuryYealdDaily02YearSynchronizedNotificationHandler")
public class TreasuryYealdDaily02YearSynchronizedNotificationHandler implements NotificationHandler {

	private TreasuryYealdDaily02YearSynchronizedNotification notification;
	...
	public TreasuryYealdDaily02YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdDaily02YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_DAILY_02_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(TreasuryYealdDaily02YearSynchronizedDomainEvent domainEvent) {
