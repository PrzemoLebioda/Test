...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdWeekly02YearSynchronizedNotification;
...
@Component("TreasuryYealdWeekly02YearSynchronizedNotificationHandler")
public class TreasuryYealdWeekly02YearSynchronizedNotificationHandler implements NotificationHandler{

	private TreasuryYealdWeekly02YearSynchronizedNotification notification;
	...
	public TreasuryYealdWeekly02YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdWeekly02YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_WEEKLY_02_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService>  buildCommand(TreasuryYealdWeekly02YearSynchronizedDomainEvent domainEvent) {
