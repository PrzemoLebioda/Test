...
import com.comida.sia.exchangequote.port.messaging.ExchangeQuoteInterday05MinSynchronizedNotification;
...
@Component("ExchangeQuoteInterday05MinSynchronizedNotificationHandler")
public class ExchangeQuoteInterday05MinSynchronizedNotificationHandler implements NotificationHandler{
	
	private ExchangeQuoteInterday05MinSynchronizedNotification notification;
	...
	public ExchangeQuoteInterday05MinSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, ExchangeQuoteInterday05MinSynchronizedNotification.class);
			
			if(notification.getSubject().equals(Subject.EXCHANGE_QUOTE_INTERDAY_05_SYNCED)) {
				return true;
			} else {
				return false;
			}
	...
	private Command<ExchangeQuotesSynchronizationSupervisorService> buildCommand(ExchangeQuoteInterday05MinSynchronizedDomainEvent domainEvent) {
