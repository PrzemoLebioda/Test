...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdWeekly10YearSynchronizedNotification;
...
@Component("TreasuryYealdWeekly10YearSynchronizedNotificationHandler")
public class TreasuryYealdWeekly10YearSynchronizedNotificationHandler implements NotificationHandler{

	private TreasuryYealdWeekly10YearSynchronizedNotification notification;
	...
	public TreasuryYealdWeekly10YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdWeekly10YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_WEEKLY_10_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService>  buildCommand(TreasuryYealdWeekly10YearSynchronizedDomainEvent domainEvent) {
