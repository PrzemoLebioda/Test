...
import com.comida.sia.fundamentals.port.messaging.balancesheet.BalanceSheetAnnualReportSynchronizedNotification;
...
@Component("BalanceSheetAnnualReportSynchronizedNotificationHandler")
public class BalanceSheetAnnualReportSynchronizedNotificationHandler implements NotificationHandler {

	private BalanceSheetAnnualReportSynchronizedNotification notification;
	...
	public BalanceSheetAnnualReportSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, BalanceSheetAnnualReportSynchronizedNotification.class);
			
			if(Subject.BALANCE_SHEET_ANNUAL_REPORT_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<CompanySynchronizationSupervisorService> buildCommand(BalanceSheetAnnualReportSynchronizedDomainEvent domainEvent) {
