...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdDaily07YearSynchronizedNotification;
...
@Component("TreasuryYealdDaily07YearSynchronizedNotificationHandler")
public class TreasuryYealdDaily07YearSynchronizedNotificationHandler implements NotificationHandler{
	
	private TreasuryYealdDaily07YearSynchronizedNotification notification;
	...
	public TreasuryYealdDaily07YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdDaily07YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_DAILY_07_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(TreasuryYealdDaily07YearSynchronizedDomainEvent domainEvent) {
