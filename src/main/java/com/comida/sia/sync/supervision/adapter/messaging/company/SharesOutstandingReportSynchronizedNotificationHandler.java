...
import com.comida.sia.fundamentals.port.messaging.sharesoutstanding.SharesOutstandingReportSynchronizedNotification;
...
@Component("SharesOutstandingReportSynchronizedNotificationHandler")
public class SharesOutstandingReportSynchronizedNotificationHandler implements NotificationHandler {

	private SharesOutstandingReportSynchronizedNotification notification;
	...
	public SharesOutstandingReportSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, SharesOutstandingReportSynchronizedNotification.class);
			
			if(Subject.SHARES_OUTSTANDING_REPORT_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<CompanySynchronizationSupervisorService> buildCommand(SharesOutstandingReportSynchronizedDomainEvent domainEvent) {
