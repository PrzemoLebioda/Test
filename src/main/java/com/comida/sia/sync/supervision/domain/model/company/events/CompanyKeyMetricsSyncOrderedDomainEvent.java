...
public class CompanyKeyMetricsSyncOrderedDomainEvent extends SyncTickerTaggedDomainEvent {
	
	public CompanyKeyMetricsSyncOrderedDomainEvent(
			String tickerSymbol,
	...
	public Subject getSubject() {
		return Subject.COMPANY_KEY_METRICS_SYNC_ORDERED;
	}
}
