...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdMonthly03MonthSynchronizedNotification;
...
@Component("TreasuryYealdMonthly03MonthSynchronizedNotificationHandler")
public class TreasuryYealdMonthly03MonthSynchronizedNotificationHandler implements NotificationHandler {

	private TreasuryYealdMonthly03MonthSynchronizedNotification notification;
	...
	public TreasuryYealdMonthly03MonthSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdMonthly03MonthSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_MONTHLY_03_MONTH_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService>  buildCommand(TreasuryYealdMonthly03MonthSynchronizedDomainEvent domainEvent) {
