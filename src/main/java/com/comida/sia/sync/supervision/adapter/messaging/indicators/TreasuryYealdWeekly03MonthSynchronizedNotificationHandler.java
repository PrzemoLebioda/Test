...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdWeekly03MonthSynchronizedNotification;
...
@Component("TreasuryYealdWeekly03MonthSynchronizedNotificationHandler")
public class TreasuryYealdWeekly03MonthSynchronizedNotificationHandler implements NotificationHandler{

	private TreasuryYealdWeekly03MonthSynchronizedNotification notification;
	...
	public TreasuryYealdWeekly03MonthSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdWeekly03MonthSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_WEEKLY_03_MONTH_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService>  buildCommand(TreasuryYealdWeekly03MonthSynchronizedDomainEvent domainEvent) {
