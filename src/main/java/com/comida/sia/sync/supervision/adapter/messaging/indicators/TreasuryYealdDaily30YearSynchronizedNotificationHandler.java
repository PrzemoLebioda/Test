...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdDaily30YearSynchronizedNotification;
...
@Component("TreasuryYealdDaily30YearSynchronizedNotificationHandler")
public class TreasuryYealdDaily30YearSynchronizedNotificationHandler implements NotificationHandler{
	
	private TreasuryYealdDaily30YearSynchronizedNotification notification;
	...
	public TreasuryYealdDaily30YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdDaily30YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_DAILY_30_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(TreasuryYealdDaily30YearSynchronizedDomainEvent domainEvent) {
