...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdDaily03MonthSynchronizedNotification;
...
@Component("TreasuryYealdDaily03MonthSynchronizedNotificationHandler")
public class TreasuryYealdDaily03MonthSynchronizedNotificationHandler implements NotificationHandler{

	private TreasuryYealdDaily03MonthSynchronizedNotification notification;
	...
	public TreasuryYealdDaily03MonthSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdDaily03MonthSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_DAILY_03_MONTH_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(TreasuryYealdDaily03MonthSynchronizedDomainEvent domainEvent) {
