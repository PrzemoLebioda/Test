...
import com.comida.sia.fundamentals.port.messaging.cashflow.CashFlowAnnualReportSynchronizedNotification;
...
@Component("CashFlowAnnualReportSynchronizedNotificationHandler")
public class CashFlowAnnualReportSynchronizedNotificationHandler implements NotificationHandler {

	private CashFlowAnnualReportSynchronizedNotification notification;
	...
	public CashFlowAnnualReportSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, CashFlowAnnualReportSynchronizedNotification.class);
	...
	private Command<CompanySynchronizationSupervisorService> buildCommand(CashFlowAnnualReportSynchronizedDomainEvent domainEvent) {
