...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdMonthly07YearSynchronizedNotification;
...
@Component("TreasuryYealdMonthly07YearSynchronizedNotificationHandler")
public class TreasuryYealdMonthly07YearSynchronizedNotificationHandler implements NotificationHandler{

	private TreasuryYealdMonthly07YearSynchronizedNotification notification;
	...
	public TreasuryYealdMonthly07YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdMonthly07YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_MONTHLY_07_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService>  buildCommand(TreasuryYealdMonthly07YearSynchronizedDomainEvent domainEvent) {
