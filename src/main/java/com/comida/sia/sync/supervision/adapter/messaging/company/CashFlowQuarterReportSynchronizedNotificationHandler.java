...
import com.comida.sia.fundamentals.port.messaging.cashflow.CashFlowQuarterReportSynchronizedNotification;
...
@Component("CashFlowQuarterReportSynchronizedNotificationHandler")
public class CashFlowQuarterReportSynchronizedNotificationHandler implements NotificationHandler{

	private CashFlowQuarterReportSynchronizedNotification notification;
	...
	public CashFlowQuarterReportSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, CashFlowQuarterReportSynchronizedNotification.class);
			
			if(Subject.CASH_FLOW_ANNUAL_REPORT_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<CompanySynchronizationSupervisorService> buildCommand(CashFlowQuarterReportSynchronizedDomainEvent domainEvent) {
