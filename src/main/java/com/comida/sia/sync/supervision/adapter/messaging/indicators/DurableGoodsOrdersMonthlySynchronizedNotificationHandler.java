...
import com.comida.sia.indicators.port.messaging.durables.DurableGoodsOrdersMonthlySynchronizedNotification;
...
@Component("DurableGoodsOrdersMonthlySynchronizedNotificationHandler")
public class DurableGoodsOrdersMonthlySynchronizedNotificationHandler implements NotificationHandler {

	private DurableGoodsOrdersMonthlySynchronizedNotification notification;
	...
	public DurableGoodsOrdersMonthlySynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, DurableGoodsOrdersMonthlySynchronizedNotification.class);
			
			if(Subject.DURABLE_GOODS_ORDER_MONTHLY_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(DurableGoodsOrdersMonthlySynchronizedDomainEvent domainEvent) {
