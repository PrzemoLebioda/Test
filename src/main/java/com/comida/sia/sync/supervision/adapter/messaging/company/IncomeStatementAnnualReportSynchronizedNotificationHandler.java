...
import com.comida.sia.fundamentals.port.messaging.income.IncomeStatementAnnualReportSynchronizedNotification;
...
@Component("IncomeStatementAnnualReportSynchronizedNotificationHandler")
public class IncomeStatementAnnualReportSynchronizedNotificationHandler implements NotificationHandler {

	private IncomeStatementAnnualReportSynchronizedNotification notification;
	...
	public IncomeStatementAnnualReportSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, IncomeStatementAnnualReportSynchronizedNotification.class);
	...
	private Command<CompanySynchronizationSupervisorService> buildCommand(IncomeStatementAnnualReportSynchronizedDomainEvent domainEvent) {
