...
import com.comida.sia.indicators.port.messaging.intrestrate.IntrestRateMonthlySynchronizedNotification;
...
@Component("IntrestRateMonthlySynchronizedNotificationHandler")
public class IntrestRateMonthlySynchronizedNotificationHandler implements NotificationHandler {

	private IntrestRateMonthlySynchronizedNotification notification;
	...
	public IntrestRateMonthlySynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, IntrestRateMonthlySynchronizedNotification.class);
			
			if(Subject.INTREST_RATE_MONTHLY_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(IntrestRateMonthlySynchronizedDomainEvent domainEvent) {
