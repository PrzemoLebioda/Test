...
import com.comida.sia.fundamentals.port.messaging.corpoevents.splits.CorporateSplitEventSynchronizedNotification;
...
@Component("CorporateSplitEventSynchronizedNotificationHandler")
public class CorporateSplitEventSynchronizedNotificationHandler implements NotificationHandler {

	private CorporateSplitEventSynchronizedNotification notification;
	...
	public CorporateSplitEventSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, CorporateSplitEventSynchronizedNotification.class);
			
			if(Subject.CALENDAR_SPLITS_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<CompanySynchronizationSupervisorService> buildCommand(CorporateSplitEventSynchronizedDomainEvent domainEvent) {
