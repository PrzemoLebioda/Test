...
import com.comida.sia.indicators.port.messaging.gdp.GdpQuarterSynchronizedNotification;
...
@Component("GdpQuarterSynchronizedNotificationHandler")
public class GdpQuarterSynchronizedNotificationHandler implements NotificationHandler{
	
	private GdpQuarterSynchronizedNotification notification;
	...
	public GdpQuarterSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, GdpQuarterSynchronizedNotification.class);
	...
	private Command<IndicatorsSynchronizationSupervisorService> buildCommand(GdpQuarterSynchronizedDomainEvent domainEvent) {
