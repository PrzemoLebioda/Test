...
public class CalculateCurrentDelistedStockSyncStateCommand extends Command<StockSynchronizationSupervisorService> {

	private SynchronizationSummary summary;
	
	public CalculateCurrentDelistedStockSyncStateCommand(
	...
	@Override
	public void execute() {
		requestClass.calculateDelistedStocksCurrentSyncState(summary);	
	}
}
