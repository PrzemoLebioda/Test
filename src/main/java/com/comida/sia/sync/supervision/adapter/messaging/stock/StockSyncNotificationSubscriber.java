...
@Component("StockSyncNotificationSubscriber")
public class StockSyncNotificationSubscriber extends NotificationSubscriber {

	public StockSyncNotificationSubscriber() {
		super();
	}
