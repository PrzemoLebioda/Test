...
import com.comida.sia.indicators.port.messaging.treasuryyeald.TreasuryYealdMonthly30YearSynchronizedNotification;
...
@Component("TreasuryYealdMonthly30YearSynchronizedNotificationHandler")
public class TreasuryYealdMonthly30YearSynchronizedNotificationHandler implements NotificationHandler {

	private TreasuryYealdMonthly30YearSynchronizedNotification notification;
	...
	public TreasuryYealdMonthly30YearSynchronizedNotificationHandler(
	...
	public boolean canHandle(String message) {
		try {
			notification = NotificationSerializer
					.instance()
					.deserialize(message, TreasuryYealdMonthly30YearSynchronizedNotification.class);
			
			if(Subject.TREASURY_YEALD_MONTHLY_30_YEAR_SYNCED.equals(notification.getSubject())) {
				return true;
			} else {
				return false;
			}
	...
	private Command<IndicatorsSynchronizationSupervisorService>  buildCommand(TreasuryYealdMonthly30YearSynchronizedDomainEvent domainEvent) {
