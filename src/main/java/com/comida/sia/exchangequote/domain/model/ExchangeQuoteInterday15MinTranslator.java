...
public class ExchangeQuoteInterday15MinTranslator implements ModelTranslator<ExchangeQuotationEntry, ExchangeQuoteInterday15Min>{

	@Override
	public ExchangeQuoteInterday15Min translate(ExchangeQuotationEntry source) throws ParseException {
		return new ExchangeQuoteInterday15Min.ExchangeQuoteInterday15MinBuilder(UUID.randomUUID())
				//.exchange(null)
				//.sector("")
				//.industry("")
				//.symbol("")
