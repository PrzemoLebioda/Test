...
public class ExchangeQuoteInterday05MinTranslator implements ModelTranslator<ExchangeQuotationEntry, ExchangeQuoteInterday05Min>{

	@Override
	public ExchangeQuoteInterday05Min translate(ExchangeQuotationEntry source) throws ParseException {
		return new ExchangeQuoteInterday05Min.ExchangeQuoteInterday05MinBuilder(UUID.randomUUID())
				//.exchange(null)
				//.sector("")
				//.industry("")
				//.symbol("")
