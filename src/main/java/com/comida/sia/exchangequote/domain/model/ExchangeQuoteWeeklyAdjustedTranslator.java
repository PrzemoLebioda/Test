...
public class ExchangeQuoteWeeklyAdjustedTranslator implements ModelTranslator<ExchangeQuotationEntry, ExchangeQuoteWeeklyAdjusted>{

	@Override
	public ExchangeQuoteWeeklyAdjusted translate(ExchangeQuotationEntry source) throws ParseException {
		return new ExchangeQuoteWeeklyAdjusted.ExchangeQuoteWeeklyAdjustedBuilder(UUID.randomUUID())
				//.exchange(null)
				//.sector("")
				//.industry("")
				//.symbol("")
