...
public class ExchangeQuoteInterday60MinTranslator implements ModelTranslator<ExchangeQuotationEntry, ExchangeQuoteInterday60Min>{

	@Override
	public ExchangeQuoteInterday60Min translate(ExchangeQuotationEntry source) throws ParseException {
		return new ExchangeQuoteInterday60Min.ExchangeQuoteInterday60MinBuilder(UUID.randomUUID())
				//.exchange(null)
				//.sector("")
				//.industry("")
				//.symbol("")
