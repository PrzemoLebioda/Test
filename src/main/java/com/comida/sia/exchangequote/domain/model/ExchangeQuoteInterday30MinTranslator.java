...
public class ExchangeQuoteInterday30MinTranslator implements ModelTranslator<ExchangeQuotationEntry, ExchangeQuoteInterday30Min>{

	@Override
	public ExchangeQuoteInterday30Min translate(ExchangeQuotationEntry source) throws ParseException {
		return new ExchangeQuoteInterday30Min.ExchangeQuoteInterday30MinBuilder(UUID.randomUUID())
				//.exchange(null)
				//.sector("")
				//.industry("")
				//.symbol("")
